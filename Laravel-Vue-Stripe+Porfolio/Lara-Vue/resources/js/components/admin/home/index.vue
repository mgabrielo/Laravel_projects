                ...
                <section class="overview" id="overview">
                    <div class="overview_left">
                        ...
                        <div class="overview_skills">
                            ...
                            <div class="skills_data">
                                <div class="skills_titles">
                                    ...
                                    <span class="skills_number">98%</span>
                                </div>
                            ...
                            <div class="skills_data">
                                <div class="skills_titles">
                                    ...
                                    <span class="skills_number">82%</span>
                                </div>
                                <div class="skills_bar">
                            ...
                            <div class="skills_data">
                                <div class="skills_titles">
                                    <h3 class="skills_name">Laravel PHP</h3>
                            ...
                            <div class="skills_data">
                                <div class="skills_titles">
                                    ...
                                    <span class="skills_number">87%</span>
                                </div>
                                <div class="skills_bar">
                                    <span class="skills_percentage skills_js"></span>
                                </div>
                        ...
                        <div class="overview_skills">
                            ...
                            <div class="skills_data">
                                <div class="skills_titles">
                                    <h3 class="skills_name">Java/Kotlin</h3>
                            ...
                            <div class="skills_data">
                                <div class="skills_titles">
                                    <h3 class="skills_name">Raect Native</h3>
                                    <span class="skills_number">89%</span>
                                </div>
                                <div class="skills_bar">
                                    <span class="skills_percentage skills_css"></span>
                                </div>
                            ...
                            <div class="skills_data">
                                <div class="skills_titles">
                                    <h3 class="skills_name">Ionic-Angular</h3>
                        ...
                        <div class="overview_skills">
                            ...
                            <div class="skills_data">
                                <div class="skills_titles">
                                    ...
                                    <span class="skills_number">73%</span>
                                </div>
                                <div class="skills_bar">
                                    <span class="skills_percentage skills_js"></span>
                                </div>
                        ...
                        <div class="overview_cards">
                            <div class="overview_cards-item">
                                ...
                                <div class="overview_link">
                                    <span></span>
                                    <router-link to="/admin/skill">View Reports</router-link>
                                </div>
                            </div>
                            <div class="overview_cards-item">
                                <div class="overview_data">
                                ...
                                <div class="overview_link">
                                    <span></span>
                                    <router-link to="/admin/educations">View Reports</router-link>
                                </div>
                            </div>
                            <div class="overview_cards-item">
                                <div class="overview_data">
                            ...
                            <div class="overview_cards-item">
                                ...
                                <div class="overview_link">
                                    <span></span>
                                    <router-link to="/admin/projects">View Reports</router-link>
                                </div>
                            </div>
                            <!-- <div class="overview_cards-item">
                                <div class="overview_data">
